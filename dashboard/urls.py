...
urlpatterns = [
    ...
    path("add-office-particulars/<int:application_id>/",
         views.AddOfficeParticularsView.as_view(),
         name="add_office_particulars"),
    path("add-paid-open-vote-service/<int:application_id>/",
         views.AddPaidOpenVoteServiceView.as_view(),
         name="add_paid_open_vote_service"),
    ...
    path("delete-office-particulars/<int:pk>/",
         views.DeleteOfficeParticularsView.as_view(),
         name="delete_office_particulars"),
    path("delete-paid-open-vote-service/<int:pk>/",
         views.DeletePaidOpenVoteServiceView.as_view(),
         name="delete_paid_open_vote_service"),
